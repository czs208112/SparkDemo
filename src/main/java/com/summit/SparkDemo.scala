...
object SparkDemo {
  def main(args: Array[String]) {
    ...
    //      .setMaster("spark://192.168.128.140:7077")// 运行在集群中
    ...
    /**
      ...
      */
//    val lines = sc.textFile("hdfs://192.168.128.140:9000/user/hadoop/WordCount.txt") //由提交参数制定读取的文件
     val lines = sc.textFile("F:/aaaa.log") // 读取本地文件
    ...
    wordscount.saveAsTextFile("f:/rrrrrr")
